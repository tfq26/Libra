<template>
    <footer class="bg-platinum-200 dark:bg-eerie_black-700 border-t border-platinum-300 dark:border-jet-400 py-8 mt-16">
      <div class="container mx-auto px-6 sm:px-8">
        <div class="flex flex-col md:flex-row justify-between items-center">
          <div class="text-eerie_black-400 dark:text-platinum-400 text-sm mb-4 md:mb-0">
            &copy; 2025 Libra. All rights reserved.
          </div>
          <div class="flex space-x-6">
            <a href="#" class="text-eerie_black-400 hover:text-saffron-500 dark:text-platinum-400 dark:hover:text-saffron-500 transition-colors duration-300">
